...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <h1 class="display-4">Hello world for Minh Docker Jenkins final 1!</h1>
      <p class="lead">This is a very simple website template that uses bootstrap CSS framework!</p>
      <p class="lead">This website is build automatically by Jenkins and Docker final 1!!! Yeahhhh Boo ya 1!!!</p>
      <hr class="my-4">
